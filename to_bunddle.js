...
const TGTJS = path.join(__dirname, 'output/resources/app/public/content/mathalive_lib/bunddle.js');
const TGTCSS = path.join(__dirname, 'output/resources/app/public/content/mathalive_lib/bunddle.css');
